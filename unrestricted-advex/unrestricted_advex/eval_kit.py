...
def evaluate_bird_or_bicycle_model(model_fn, dataset_iter=None, model_name=None):
  ...
  attack_list = [
    ...
    attacks.SpsaWithRandomSpatialAttack(model_fn, image_shape_hwc=bird_or_bicycle_shape, spatial_limits=bird_or_bicycle_spatial_limits, black_border_size=bird_or_bicycle_black_border_size, epsilon=(16. / 255), num_steps=32,),
